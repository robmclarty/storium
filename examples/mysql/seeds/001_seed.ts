...
export default defineSeed(async ({ drizzle }) => {
  ...
  await drizzle.execute(sql`
    INSERT INTO posts (id, title, body, status, author_id, tags, metadata) VALUES
      ...
      ('b0000000-0000-0000-0000-000000000004', 'MySQL Tips', 'JSON functions, stored procedures...', 'published', 'a0000000-0000-0000-0000-000000000002', '["tutorial", "mysql"]', '{"featured": true}')
  `)
})
