/**
 * SQLite example — full lifecycle with a file-based database
 *
 * Demonstrates:
 ...
 *  - Custom queries (search, domain actions, SQLite-specific)
 *  - SQLite-specific features: json_extract(), json_each(), LIKE
 *  - Transactions
...
// Tags stored as JSON array — queried with json_each()
