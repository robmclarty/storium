...
describe('resolveConfigPath', () => {
  ...
  /* QA-10032 */ it('[QA-10032] respects STORIUM_CONFIG env var', () => {
  ...
  /* QA-10033 */ it('[QA-10033] respects DRIZZLE_CONFIG env var when STORIUM_CONFIG is not set', () => {
  ...
  /* QA-10034 */ it('[QA-10034] STORIUM_CONFIG takes priority over DRIZZLE_CONFIG', () => {
  ...
  /* QA-10035 */ it('[QA-10035] finds storium.config.ts in cwd', () => {
    delete process.env.STORIUM_CONFIG
    delete process.env.DRIZZLE_CONFIG
  ...
  /* QA-10036 */ it('[QA-10036] falls back to drizzle.config.ts when storium.config.ts absent', () => {
    delete process.env.STORIUM_CONFIG
    delete process.env.DRIZZLE_CONFIG
  ...
  /* QA-10037 */ it('[QA-10037] defaults to storium.config.ts when no config file found', () => {
    delete process.env.STORIUM_CONFIG
    delete process.env.DRIZZLE_CONFIG
...
describe('loadConfig', () => {
  /* QA-10038 */ it('[QA-10038] throws ConfigError when config has no dialect', async () => {
  ...
  /* QA-10039 */ it('[QA-10039] includes tsx hint for .ts files on import failure', async () => {
    try {
